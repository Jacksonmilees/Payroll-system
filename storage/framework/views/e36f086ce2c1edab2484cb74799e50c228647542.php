                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group<?php echo $errors->has('leave_days') ? ' has-error' : ''; ?> has-feedback">
                                <input type="number" name="leave_days" id="leave_days" class="form-control" value="<?php echo $leave_category['leave_days']; ?>" placeholder="<?php echo __('Enter number of leaves..'); ?>">
