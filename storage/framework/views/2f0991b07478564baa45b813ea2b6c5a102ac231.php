                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group<?php echo $errors->has('loan_description') ? ' has-error' : ''; ?> has-feedback">
                                <textarea class="textarea text-description" name="loan_description" id="loan_description" placeholder="<?php echo __('Enter loan description..'); ?>"><?php echo $loan['loan_description']; ?></textarea>
