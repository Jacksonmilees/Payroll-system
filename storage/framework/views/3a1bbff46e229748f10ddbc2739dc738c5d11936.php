<?php $__env->startSection('title', __('Manage '.$title)); ?>
...
<div class="content-wrapper wow fadeInDown" data-wow-duration=".5s" data-wow-delay=".2s">
    ...
    <section class="content-header">
        <h1>
           <?php echo strtoupper($title ?? 'Allowance & Deduction'); ?> 
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo url('/dashboard'); ?>"><i class="fa fa-dashboard"></i><?php echo __(' Dashboard'); ?> </a></li>
            <li><a><?php echo __('Deduction'); ?></a></li>
            <li class="active"><?php echo __('Manage '.$title); ?></li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo __('Manage '.$title); ?></h3>
            ...
            <div class="box-body">
                ...
                <div class="col-md-6">
                    <a href="<?php echo url('/hrm/'.$type.'/create'); ?>" class="btn btn-primary btn-flat"><i class="fa fa-plus"></i> <?php echo __('Add '.$title); ?></a>
                </div>
                <div  class="col-md-6">
                    ...
                    <table  class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo __($title.' Name'); ?></th>
                                <th><?php echo __($title.' Month'); ?></th>
                                <th><?php echo __($title.' Amount'); ?></th>
                        ...
                        <tbody id="myTable">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo url('/hrm/'.$type.'/edit/' . $deduction['id']); ?>"><i class="icon fa fa-edit"></i> <?php echo __('Edit'); ?></a> &nbsp;
                                    <a href="<?php echo url('/hrm/'.$type.'/delete/' . $deduction['id']); ?>"><i class="icon fa fa-trash"></i> <?php echo __('Delete'); ?></a>
                                </td>
                            </tr>
