<?php $__env->startSection('title', __('Job Groups')); ?>
...
<div class="content-wrapper wow fadeInDown" data-wow-duration=".5s" data-wow-delay=".2s">
    ...
    <section class="content-header">
        <h1>
           <?php echo __('JOB GROUP'); ?> 
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo url('/dashboard'); ?>"><i class="fa fa-dashboard"></i> <?php echo __('Dashboard'); ?></a></li>
            <li><a><?php echo __('Setting'); ?></a></li>
            <li class="active"><?php echo __('Job Groups'); ?></li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo __('Manage job groups'); ?></h3>
            ...
            <div class="box-body">
                ...
                <div  class="col-md-6">
                    <a href="<?php echo url('/setting/departments/create'); ?>" class="btn btn-primary btn-flat"><i class="fa fa-plus"></i> <?php echo __('Add Job Group'); ?></a>
                </div>
                <div  class="col-md-6">
                    ...
                    <table  class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo __('Job Group'); ?></th>
                                <th><?php echo __('Job Group Description'); ?></th>
