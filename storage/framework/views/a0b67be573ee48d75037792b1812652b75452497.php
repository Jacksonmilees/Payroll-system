                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group<?php echo $errors->has('bonus_description') ? ' has-error' : ''; ?> has-feedback">
                                <textarea class="textarea text-description" name="bonus_description" id="bonus_description" placeholder="<?php echo __('Enter bonus description..'); ?>"><?php echo old('bonus_description'); ?></textarea>
