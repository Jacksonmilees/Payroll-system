          ...
          <div class="box box-warning">
            ...
            <div class="box-body">
              ...
              <div class="form-group<?php echo $errors->has('shif') ? ' has-error' : ''; ?>">
                ...
                <input type="number" name="shif" readonly value="0" class="form-control" id="nhif" placeholder="<?php echo __('Enter SHIF deduction..'); ?>">
              ...
              <div class="form-group<?php echo $errors->has('nssf') ? ' has-error' : ''; ?>">
                ...
                <input type="number" name="nssf" readonly value="0" class="form-control" id="nssf" placeholder="<?php echo __('Enter NSSF deduction..'); ?>">
        ...
        <div class="col-md-6">
          <div class="box box-danger">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                <label for="nhif_relief"><?php echo __('NHIF relief'); ?></label>
