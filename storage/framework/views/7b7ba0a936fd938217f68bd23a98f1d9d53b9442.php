                    ...
                    <table  class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo __('T.Allowance'); ?></th>
                                <th><?php echo __('T.Deductions'); ?></th>
                        ...
                        <tbody id="myTable">
                            ...
                            <tr>
                                <td><?php echo $sl++; ?></td>
                                <td><?php echo $salary['name'] .' '.$salary['mother_name'] .' ' .$salary['father_name']; ?></td>
                                <td><?php echo $salary['designation']; ?></td>
                                
                                <td>
                                <?php
                                $allowance = $salary['house_rent_allowance'] + $salary['medical_allowance'] + $salary['special_allowance'] + $salary['other_allowance'];
                                $gross_salary = $salary['basic_salary'] + $allowance;
                                $total_deduction = $salary['tax_deduction'] + $salary['provident_fund_deduction'] + $salary['other_deduction'] +  $salary['nhif']+  $salary['nssf'];
                                ?>
                                <?php echo $gross_salary; ?>

                                </td>
                                <td><?php echo $salary['paye']; ?></td>
                                <td>
                                    <?php echo $allowance; ?>
