...
<?php $__env->startSection('title',(isset($selectedUser) ? ucfirst($selectedUser->name .' '. $selectedUser->father_name) : '').' P9 REPORT'); ?>
...
<div class="content-wrapper wow fadeInDown" data-wow-duration=".5s" data-wow-delay=".2s">
    ...
    <section class="content-header">
        <h1>
        <?php echo __('P9 Report'); ?>

        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo url('/dashboard'); ?>"><i class="fa fa-dashboard"></i> <?php echo __('Dashboard'); ?></a></li>
            <li><a><?php echo __('Reports'); ?></a></li>
            <li class="active"><?php echo __('P9 Report'); ?></li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo __('P9 Report'); ?></h3>
            ...
            <div class="box-body">
                        ...
                        <form action="<?php echo URL::current();; ?>" method="GET">
                            <div class="mb-3" style="display: flex;">
                                <select name="employee" id="" class="form-control" style="margin-top: 10px;">
                                    ...
                                    <?php $__currentLoopData = $allEmployees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employeeData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo $employeeData->id; ?>" <?php echo (request()->employee == $employeeData->id) ? 'selected' : ''; ?>><?php echo $employeeData->name; ?></option>
                ...
                <?php endif; ?>
                <?php if(request()->employee): ?>
                 <div class="col-md-8">
                    <div class="my-2">
                        <div class="mb-3" style="">
                            <div class="col-md-6">
                                <h4 style="margin: 5px;">Employer's Name: <span><?php echo env('EMP_NAME', 0); ?></span></h4>
                                <h4 style="margin: 5px;">Employee Name: <span><?php echo ucfirst($selectedUser->name .' '. $selectedUser->mother_name .' '. $selectedUser->father_name); ?></span></h4>
                            </div>
                            <div class="col-md-6">
                                <h4 style="margin: 5px;">Employer's Pin: <span><?php echo env('EMP_NUMBER', 0); ?></span></h4>
                                <h4 style="margin: 5px;">Employee's KRA Pin: <span><?php echo $selectedUser->kra_no; ?></span></h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <table  class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo __('BENEFITS NON CASH'); ?></th>
                                <th><?php echo __('VALUE OF QUARTERS'); ?></th>
                                <th><?php echo __('TOTAL GROSS PAY'); ?></th>
                                <th><?php echo __('NSSF CONTIBUTION BENEFIT '); ?></th>
                                <th><?php echo __('CHARGEABLE PAY'); ?></th>
                                <th><?php echo __('TAX CHARGED'); ?></th>
                                <th><?php echo __('PERSONAL RELIEF'); ?></th>
                                <th><?php echo __('INSURANCE RELIEF'); ?></th>
                                <th><?php echo __('PAYE TAX'); ?></th>
                        ...
                        <tbody id="myTable">
                            ...
                            <?php $__currentLoopData = $salary_payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $salaray_payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(date('F',strtotime($salaray_payment->payment_month)) == date('F',strtotime($month))): ?>
                                    <?php
                                      $sum             = 0.0;
                            ...
                            <tr>
                                <td><?php echo date('F',strtotime($month)); ?></td>
                                <td><?php echo number_format($monthGross[$month . 'gross'] ?? 0,2); ?></td>
                                <td>0</td>
                                <td>0</td>
                                <td><?php echo number_format($monthGross[$month . 'gross'] ?? 0,2); ?></td>
                                <td><?php echo number_format($monthGross[$month . 'nssf'] ?? 0 ?? 0,2); ?></td>
                                <td><?php echo number_format(($monthGross[$month . 'gross'] ?? 0) - ($monthGross[$month . 'nssf'] ?? 0) ,2); ?></td>
                                <td><?php echo number_format($monthGross[$month . 'income'] ?? 0 ?? 0,2); ?></td>
                                <td><?php echo number_format($monthGross[$month . 'persnol'] ?? 0 ?? 0,2); ?></td>
                                <td><?php echo number_format($monthGross[$month . 'nhif_relief'] ?? 0 ?? 0,2); ?></td>
                                <td><?php echo number_format($monthGross[$month . 'paye'] ?? 0 ?? 0,2); ?></td>
                            </tr>
                            <?php ($nssf = 0); ?>
                            <?php ($taxable_pay = 0); ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo number_format($total['gross'] ?? 0,2); ?></td>
                                <td>0</td>
                                <td>0</td>
                                <td><?php echo number_format($total['gross'] ?? 0,2); ?></td>
                                <td><?php echo number_format($total['nssf'] ?? 0 ?? 0,2); ?></td>
                                <td><?php echo number_format(($total['gross'] ?? 0) - ($total['nssf'] ?? 0) ,2); ?></td>
                                <td><?php echo number_format($total['income'] ?? 0 ?? 0,2); ?></td>
                                <td><?php echo number_format($total['persnol'] ?? 0 ?? 0,2); ?></td>
                                <td><?php echo number_format($total['nhif_relief'] ?? 0 ?? 0,2); ?></td>
                                <td><?php echo number_format($total['paye'] ?? 0 ?? 0,2); ?></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
