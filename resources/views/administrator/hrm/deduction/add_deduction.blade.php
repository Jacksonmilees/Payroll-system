...
<div class="content-wrapper wow fadeInDown" data-wow-duration=".5s" data-wow-delay=".2s">
    ...
    <section class="content">
        ...
        <div class="box box-default">
            ...
            <!-- /.box-header -->
            <form action="{{ url('/hrm/'.$type.'/store') }}" method="post" name="deduction_add_form">
                {{ csrf_field() }}
                <div class="box-body">
                    <div class="row">
                        <!-- Notification Box -->
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('deduction_name') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="deduction_name" id="deduction_name" class="form-control" value="{{ old('deduction_name') }}" placeholder="{{ __('Enter '.$title.' name..') }}">
                            ...
                            <div class="form-group{{ $errors->has('deduction_amount') ? ' has-error' : '' }} has-feedback">
                                <input type="number" name="deduction_amount" id="deduction_amount" class="form-control" value="{{ old('deduction_amount') }}" placeholder="{{ __('Enter '.$title.' name..') }}">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group{{ $errors->has('deduction_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="textarea text-description" name="deduction_description" id="deduction_description" placeholder="{{ __('Enter '.$title. ' description..') }}">{{ old('deduction_description') }}</textarea>
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i> {{ __('Add '.$title) }}</button>
                </div>
            </form>
        </div>
        <!-- /.box -->
