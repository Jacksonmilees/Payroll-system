                ...
                <div class="form-group{{ $errors->has('user_id') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-6">
                    <select name="user_id" class="form-control" id="user_id">
                      ...
                      <option value="{{ $employee['id'] }}">{{ format_employee_name($employee['name'], $employee['name_prefix'] ?? null) .' '.$employee['father_name']}}</option>
                      @endforeach
                    </select>
            ...
            <div class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group structure-field structure-daily{{ $errors->has('daily_rate') ? ' has-error' : '' }}" style="display:none;">
                  ...
                  <div class="col-sm-6">
                    <input type="number" step="0.01" name="daily_rate" class="form-control" id="daily_rate" value="{{ old('daily_rate', $salary['daily_rate']) }}" placeholder="{{ __('Enter daily rate..') }}">
                ...
                <div class="form-group structure-field structure-hourly{{ $errors->has('hourly_rate') ? ' has-error' : '' }}" style="display:none;">
                  ...
                  <div class="col-sm-6">
                    <input type="number" step="0.01" name="hourly_rate" class="form-control" id="hourly_rate" value="{{ old('hourly_rate', $salary['hourly_rate']) }}" placeholder="{{ __('Enter hourly rate..') }}">
        ...
        <div class="col-md-6">
          <div class="box box-warning">
            ...
            <div class="box-body">
              ...
              <div class="form-group{{ $errors->has('shif') ? ' has-error' : '' }}">
                <label for="nhif">{{ __('SHIF') }}</label>
                <input type="number" name="shif" readonly="" value="{{ $salary['nhif'] }}" class="form-control" id="nhif" placeholder="{{ __('Enter SHIF deduction..') }}">
                @if ($errors->has('shif'))
                <span class="help-block">
                  <strong>{{ $errors->first('shif') }}</strong>
                </span>
                @endif
              </div>
              ...
              <div class="form-group{{ $errors->has('nssf') ? ' has-error' : '' }}">
                ...
                <input type="number" name="nssf" readonly="" value="{{ $salary['nssf'] }}" class="form-control" id="nssf" placeholder="{{ __('Enter NSSF deduction..') }}">
                @if ($errors->has('nssf'))
                <span class="help-block">
              ...
              <!--  @endif-->
              <!--</div>-->
              <input type="hidden" name="other_deduction" value="{{ $salary->other_deduction }}" class="form-control" id="other_deduction">
              <input type="hidden" name="houselevy" value="{{ $salary->houselevy }}" class="form-control" id="houselevy">
        ...
        <div class="col-md-6">
          <div class="box box-danger">
            ...
            <div class="box-body">
              ...
              <div class="form-group{{ $errors->has('total_allowance') ? ' has-error' : '' }}">
                <label for="total_allowance">{{ __('Total Allowance') }}</label>
                <input type="number" disabled class="form-control" value={{$totalallowance}} id="total_allowance">
              </div>
...
<script type="text/javascript">
  ...
  document.forms['employee_salary_form'].elements['pay_structure'].value = "{{ old('pay_structure', $salary['pay_structure'] ?? 'monthly') }}";
