  ...
  <div class="container">
    ...
    <table>
      <tr>
        <td class="h3-display">
          <tr>
            <td>Full Name: </td>
            <td>{{ format_employee_name($user['name'], $user['name_prefix'] ?? null) .' '. $user['father_name'] .' ' . $user['mother_name'] }}</td>
          </tr>
          <tr>
            <td>KRA PIN: </td>
            <td>
    ...
    <table>
     ...
     <tr>
      ...
      <!--<tr>-->
      <!--  <td>-->
      <!--      {{ $data->item_name == 'NHIF' ? 'SHIF' : $data->item_name }}-->
      <!--  </td>-->
        <!--<td>&nbsp;</td>-->
      <!--  <td>-->
      <!--      @if($data->item_name == 'NHIF')-->
      <!--      -{{($salary_payment->gross_salary * 2.75 / 100)}}-->
      <!--      @endif-->
      <!--       @if($data->item_name == 'NSSF')-->
      <!--      -{{($salary_payment->gross_salary <= 36000 ? $salary_payment->gross_salary * 6 / 100 : 2160)}}-->
      <!--      @endif-->
      <!--    @if($data->status == 'debits' && $data->item_name != 'NHIF'&& $data->item_name != 'NSSF')-->
      <!--    -{{ $data->amount }}-->
      <!--    @endif-->
      <!--  </td>-->
      <!--</tr>-->
      ...
      <tr class="success">
        <td><strong class="pull-right">{{ __('SHIF Relief:') }}</strong></td>
        <!--<td>&nbsp;</td>-->
        <td>
          <strong>
            {{ number_format($nhif * 15 / 100, 2, '.', '') }}
          </strong>
        </td>
      </tr>
      <tr class="success">
        <td><strong class="pull-right">{{ __('House Leavy Relief:') }}</strong></td>
        <!--<td>&nbsp;</td>-->
        <td>
          <strong>
            {{ number_format(($clean_salary * 1.5/ 100) * 15 / 100, 2, '.', '') }}
          </strong>
        </td>
      </tr>
      ...
      <tr class="success">
        ...
        <!--<td>&nbsp;</td>-->
        <td><strong>{{ number_format($paye - $house_leavy * 15 / 100, 2, '.', '') }}</strong></td>
      </tr>
      <tr class="success">
      ...
      <tr class="success">
        ...
        <!--<td>&nbsp;</td>-->
        <td>
                    <strong>{{ number_format($paye - ($house_leavy * 15) / 100 + ($clean_salary * 1.5) / 100 + ($clean_salary * 2.75) / 100 + $nssf, 2, '.', '') }}</strong>
      ...
      <tr class="success">
        ...
        <!--<td>&nbsp;</td>-->
        <td>
                    <strong>{{ number_format($clean_salary - ($paye - ($house_leavy * 15) / 100 + (($clean_salary * 1.5) / 100 + ($clean_salary * 2.75) / 100) + $nssf), 2, '.', '') }}</strong>
            </td>
      </tr>
      <tr class="success">
