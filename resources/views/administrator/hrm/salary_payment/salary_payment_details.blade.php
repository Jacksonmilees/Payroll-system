          ...
          <div class="box-body">
            ...
            <div id="printable_area" class="table-responsive">
              <table class="table table-bordered">
                <tr>
                  <td>
                    <p>
                      {{ $user['employee_id'] }}
                      <br>
                      {{ format_employee_name($user['name'], $user['name_prefix'] ?? null) }}
                      <br>
                      ({{ $user['designation'] }})
                      <br>
                ...
                <tr>
                  <td>{{ __('Work Days:') }}</td>
                  <td>{{ $salary_payment->work_days ?? 0 }}</td>
                </tr>
                <tr>
                  <td>{{ __('Work Hours:') }}</td>
                  <td>{{ number_format($salary_payment->work_hours ?? 0, 2) }}</td>
                </tr>
                <tr>
                  <td>{{ __('Pay Basis:') }}</td>
                  <td>{{ ucfirst($salary_payment->pay_basis ?? __('monthly')) }}</td>
                </tr>
              </table>
              <hr>
